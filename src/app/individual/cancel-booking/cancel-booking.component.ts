...
import { SubmitCancelBookingRequestPayload, SubmitCreateBookingRequestPayload, TestType } from 'src/app/models/booking.model';
...
export class CancelBookingComponent implements OnInit {
	...
	ngOnInit(): void {
		this.formGroup = this._formBuilder.group({
			...
			availableDateId: new FormControl('', []),
		});
	...
	cancelBooking() {
		...
		// this.isAwaitingResponse = true;
		this._bookingService.CancelBooking(requestPayload).subscribe(
			(response: any) => {
				console.log(response);
	...
	buildSubmitRequestPayload(): SubmitCancelBookingRequestPayload {
		return {
